      ...
      <main style={{ background: "#0e0e0e", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif", padding: "80px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <div style={{ background: "#0d1f0d", border: "1px solid #1a3a1a", borderRadius: 12, padding: "20px 24px", marginBottom: 48 }}>
            <p style={{ color: "#1DB954", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", margin: "0 0 8px" }}>Das Prinzip von Audynia</p>
          ...
          <Section id="sec-1" label="1. Grundsatz und Geschäftsmodell">
            <NP n={1}>Audynia (nachfolgend &bdquo;Audynia&ldquo;) steht hinter jedem personalisierten Song den wir erstellen. Da der Kunde die Vorschau vor der Kaufentscheidung kostenlos anhört, sind unsere Erstattungsbedingungen klar, fair und auf konkrete Fälle begrenzt.</NP>
          ...
          <Section id="sec-2" label="2. Gesetzliches Widerrufsrecht (EU/UK)">
            ...
            <NP n={2}>Das Widerrufsrecht erlischt vorzeitig wenn: (a) Audynia mit der Ausführung des Vertrags begonnen hat, (b) der Kunde vor der Zahlung ausdrücklich zugestimmt hat dass die Lieferung sofort beginnt, und (c) der Kunde bestätigt hat dass er mit dieser Zustimmung sein Widerrufsrecht verliert.</NP>
            ...
            <NP n={4}>Die vollständige Widerrufsbelehrung sowie das Muster-Widerrufsformular sind unter <a href="/widerrufsbelehrung" style={{ color: "#1DB954", textDecoration: "none" }}>audynia.com/widerrufsbelehrung</a> abrufbar.</NP>
          </Section>

          {/* 3 */}
          <Section id="sec-3" label="3. Freiwillige Erstattungsgarantie — 4 Erstattungsfälle">
            <NP n={1}>Audynia gewährt unabhängig vom gesetzlichen Widerrufsrecht eine vollständige freiwillige Erstattung in den folgenden abschließend definierten Fällen:</NP>
            <div style={{ background: "#141414", border: "1px solid #252525", borderRadius: 10, overflow: "hidden", margin: "12px 0 16px" }}>
              ...
              {([
                ...
                ["Fall 3 — Zahlung ohne Preview",
                  "Der Kunde hat einen Zahlungslink erhalten ohne zuvor eine kostenlose 30-sekündige Vorschau erhalten zu haben. Das widerspricht dem Geschäftsmodell von Audynia und begründet unabhängig vom Zahlungsstatus einen Erstattungsanspruch."],
                ["Fall 4 — Technisches Lieferproblem",
                  "Der Kunde ist technisch nicht in der Lage die gelieferte MP3-Datei auf seinem Gerät herunterzuladen oder zu speichern, und Audynia kann das Problem nicht innerhalb von 48 Stunden lösen."],
            ...
            <div style={{ background: "#141414", border: "1px solid #252525", borderRadius: 10, overflow: "hidden", margin: "12px 0 16px" }}>
              ...
              {([
                ...
                ["Verstoß gegen Nutzungsbedingungen",
                  "Der Kunde hat gegen die Nutzungsbedingungen von Audynia verstoßen, insbesondere durch kommerzielle Nutzung oder missbräuchliche Eingaben im Wizard."],
          ...
          <Section id="sec-5" label="5. Kostenlose neue Demo als Alternative">
            <NP n={1}>Bevor ein Erstattungsantrag gestellt wird bietet Audynia eine Alternative an: Wenn die Preview nicht vollständig den Vorstellungen des Kunden entspricht, hat er das Recht auf eine kostenlose neue Demo die seinen Wünschen besser entspricht.</NP>
            <NP n={2}>Dieser Anspruch besteht einmalig pro Bestellung und muss per E-Mail an <a href="mailto:info@audynia.com" style={{ color: "#1DB954", textDecoration: "none" }}>info@audynia.com</a> vor der Zahlung geltend gemacht werden. Der Kunde beschreibt was ihm an der Preview nicht gefällt und was er sich anders vorstellt.</NP>
          ...
          <Section id="sec-6" label="6. Erstattungsprozess — Schritt für Schritt">
            <div style={{ background: "#141414", border: "1px solid #252525", borderRadius: 10, overflow: "hidden", margin: "0 0 16px" }}>
              ...
              {([
                ["Schritt 1", "E-Mail senden", "An: info@audynia.com · Betreff: Erstattungsantrag - [Ihre E-Mail-Adresse]"],
                ...
                ["Schritt 3", "Bearbeitungszeit", "Audynia bearbeitet Erstattungsanträge innerhalb von 5 Werktagen und meldet sich per E-Mail."],
          ...
          <Section id="sec-7" label="7. Gateway-spezifische Erstattungsregelungen">
            ...
            <InfoBox color="#1f1a00">
              ...
              <BulletList items={[
                ...
                "Paddle behält die originale Bearbeitungsgebühr ein — Audynia erstattet dem Kunden dennoch den vollen Kaufpreis",
              ]} muted />
            </InfoBox>
            ...
            <NP n={1}>Bei Stripe-Transaktionen ist Audynia der rechtliche Verkäufer und veranlasst die Erstattung direkt über das Stripe-Dashboard.</NP>
            <NP n={2}>Erstattungsfrist bei Stripe-Transaktionen: 30 Tage nach Zahlung. Alle Erstattungsanfragen richten Sie bitte an <a href="mailto:info@audynia.com" style={{ color: "#1DB954", textDecoration: "none" }}>info@audynia.com</a>.</NP>
            <NP n={3}>Stripe-Erstattungen gehen ausschließlich an die ursprüngliche Zahlungsmethode zurück. Ist die Karte abgelaufen, leitet das Kartennetzwerk die Erstattung trotzdem an das korrekte Konto weiter. Stripe behält die originale Bearbeitungsgebühr ein — Audynia trägt diese intern und erstattet den vollen Kaufpreis.</NP>
            ...
            <InfoBox color="#141414">
              ...
              <BulletList items={[
                ...
                "Audynia speichert für jede Bestellung vollständige Liefernachweise: Zeitstempel, E-Mail-Bestätigung, Download-Log mit IP-Adresse",
                "Bitte kontaktieren Sie uns vor einer Dispute-Eröffnung bei PayPal — wir lösen Probleme schnell und unbürokratisch",
              ]} muted />
            </InfoBox>
            <NP n={1}>Kontaktieren Sie uns bitte zuerst unter <a href="mailto:info@audynia.com" style={{ color: "#1DB954", textDecoration: "none" }}>info@audynia.com</a> bevor Sie eine Dispute-Anfrage bei PayPal eröffnen. Wir lösen Probleme oft noch am selben Werktag.</NP>
            <NP n={2}>PayPal-Disputes können bis zu 180 Tage nach der ursprünglichen Transaktion eröffnet werden. Audynia speichert alle relevanten Liefernachweise für diesen Zeitraum.</NP>
            ...
            <NP n={1}>Wise und Payoneer sind interne Business-Konten von Audynia und keine Endkunden-Zahlungsgateways. Kunden können keine Erstattungen über Wise oder Payoneer beantragen. Alle Erstattungsanfragen richten Sie bitte an <a href="mailto:info@audynia.com" style={{ color: "#1DB954", textDecoration: "none" }}>info@audynia.com</a>.</NP>
          </Section>
          ...
          <Section id="sec-8" label="8. Bearbeitungszeiten nach Zahlungsmethode">
            <div style={{ background: "#141414", border: "1px solid #252525", borderRadius: 10, overflow: "hidden", margin: "0 0 16px" }}>
              ...
              {([
                ...
                ["Kreditkarte via Stripe", "Ursprüngliche Karte",   "5–10 Werktage", "Stripe bearbeitet direkt — Audynia behält keine Gebühren"],
                ["PayPal",                 "PayPal-Konto",          "3–14 Werktage", "Bitte zuerst info@audynia.com kontaktieren"],
          ...
          <Section id="sec-9" label="9. Chargeback-Hinweis">
            <InfoBox color="#1f0d0d">
              ...
              <p style={{ color: "#888", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
                Audynia und Paddle bitten Sie dringend zunächst uns direkt unter info@audynia.com zu kontaktieren bevor Sie eine Rückbuchung bei Ihrer Bank oder Ihrem Kartenanbieter einleiten. Ungerechtfertigte Chargebacks können zur Sperrung Ihres Zugangs zu audynia.com führen und sind mit einer Gebühr von bis zu 20 US-Dollar verbunden.
              </p>
            </InfoBox>
            <NP n={1}>Als Nachweis für die Lieferung digitaler Produkte speichert Audynia für jede Bestellung: Transaktions-ID, Zeitstempel der Song-Bereitstellung, E-Mail-Adresse des Empfängers, Download-Zeitstempel und IP-Adresse sowie Bestätigung der Pflicht-Checkboxen. Diese Nachweise werden bei Chargebacks als Beweis eingereicht.</NP>
            <NP n={2}>Eine hohe Chargeback-Rate (über 1%) kann zur Sperrung des Merchant-Accounts bei Stripe oder Paddle führen. Audynia nimmt Chargeback-Prävention ernst und bittet alle Kunden bei Problemen zuerst den direkten Kontakt zu suchen.</NP>
          </Section>
          ...
          <Section id="sec-10" label="10. Kontakt">
            <div style={{ background: "#141414", border: "1px solid #252525", borderRadius: 10, overflow: "hidden", margin: "0 0 16px" }}>
              {([
                ["E-Mail (bevorzugt)",   <a key="mail" href="mailto:info@audynia.com" style={{ color: "#1DB954", textDecoration: "none" }}>info@audynia.com</a>],
                ["Betreff für Erstattungen", "Erstattungsantrag - [Ihre E-Mail-Adresse]"],
                ["Live-Chat",            "audynia.com (Crisp-Chat)"],
