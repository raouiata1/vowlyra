      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ color: "#888", fontSize: 15, lineHeight: 1.9 }}>
          ...
          <p style={{ margin: "0 0 16px" }}>
            Diese Allgemeinen Geschäftsbedingungen gelten für alle Verträge zwischen Vowlyra (nachfolgend „Anbieter") und dem Kunden über die Erstellung und Lieferung personalisierter KI-generierter Musikstücke über die Website vowlyra.com.
          </p>
