    ...
    <>
      ...
      <main style={{ background: "#0e0e0e", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif", padding: "80px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <p style={{ color: "#555", fontSize: 13, marginBottom: 4 }}>Rechtsform: Vowlyra LLC · Wyoming, USA · Version 2.0</p>
          ...
          <Section id="sec-1" label="§ 1  Geltungsbereich und Vertragsparteien">
            <NP n={1}>Diese Allgemeinen Geschäftsbedingungen (nachfolgend &bdquo;AGB&ldquo;) gelten für alle Verträge die zwischen Vowlyra LLC (nachfolgend &bdquo;Vowlyra&ldquo;, &bdquo;wir&ldquo; oder &bdquo;uns&ldquo;) und Verbrauchern (nachfolgend &bdquo;Kunde&ldquo; oder &bdquo;Sie&ldquo;) über die Website vowlyra.com geschlossen werden.</NP>
            <NP n={2}>Vowlyra LLC ist eine nach dem Recht des Bundesstaates Wyoming (USA) gegründete Limited Liability Company.</NP>
            <DataTable rows={[
              ["Anbieter",       "Vowlyra LLC"],
            ...
            <NP n={3}>Verbraucher im Sinne dieser AGB ist jede natürliche Person die ein Rechtsgeschäft zu Zwecken abschließt die überwiegend weder ihrer gewerblichen noch ihrer selbständigen beruflichen Tätigkeit zugerechnet werden können (§ 13 BGB). Vowlyra richtet sein Angebot ausschließlich an Verbraucher.</NP>
            <NP n={4}>Entgegenstehende oder abweichende Bedingungen des Kunden werden nicht anerkannt, es sei denn Vowlyra stimmt ihrer Geltung ausdrücklich schriftlich zu.</NP>
            <NP n={5}>Diese AGB gelten in der zum Zeitpunkt der Bestellung gültigen Fassung. Die jeweils aktuelle Version ist unter vowlyra.com/agb abrufbar.</NP>
          </Section>
          ...
          <Section id="sec-2" label="§ 2  Zahlungsabwicklung und Merchant of Record">
            ...
            <BulletList items={[
              ...
              "Vowlyra ist in diesem Fall der technische Leistungserbringer im Hintergrund",
          ...
          <Section id="sec-3" label="§ 3  Mindestalter und Vertragsvoraussetzungen">
            <NP n={1}>Das Angebot von Vowlyra richtet sich ausschließlich an Personen die das 18. Lebensjahr vollendet haben. Mit Abschluss einer Bestellung bestätigt der Kunde ausdrücklich dass er mindestens 18 Jahre alt ist.</NP>
            <NP n={2}>Minderjährige sind von der Nutzung des Angebots ausgeschlossen. Vowlyra behält sich das Recht vor Bestellungen abzulehnen oder zu stornieren wenn Anhaltspunkte dafür bestehen dass der Kunde minderjährig ist.</NP>
          ...
          <Section id="sec-4" label="§ 4  Angebot und Vertragsschluss">
            <NP n={1}>Die Darstellung der Produkte auf vowlyra.com stellt kein rechtlich bindendes Angebot sondern eine unverbindliche Aufforderung zur Bestellung dar (invitatio ad offerendum).</NP>
            ...
            <BulletList items={[
              ...
              "Mit erfolgreicher Zahlung gibt der Kunde ein verbindliches Kaufangebot ab. Vowlyra nimmt dieses durch Bereitstellung des Songs und Versand einer Auftragsbestätigung an.",
            ]} />
            <NP n={3}>Ein Vertrag kommt ausschließlich in deutscher Sprache zustande. Der Vertragstext wird von Vowlyra nicht gespeichert und ist nach Vertragsschluss nicht mehr zugänglich. Es wird empfohlen diese AGB sowie die Auftragsbestätigung zu speichern.</NP>
          </Section>

          {/* § 5 */}
          <Section id="sec-5" label="§ 5  Produkte, Preise und Lieferung">
            <NP n={1}>Vowlyra bietet folgende Produkte an:</NP>
            <div style={{ background: "#141414", border: "1px solid #252525", borderRadius: 10, overflow: "hidden", margin: "12px 0 16px" }}>
              ...
              {([
                ...
                ["Qualitätskontrolle",  "Standard-Produktion",                 "Persönliche Qualitätskontrolle durch Vowlyra-Team"],
            ...
            <NP n={2}>Alle Preise verstehen sich in Euro (EUR) als Einmalzahlung inklusive gesetzlicher Mehrwertsteuer soweit anwendbar. Vowlyra behält sich das Recht vor Preise jederzeit anzupassen. Für den Kunden gilt ausschließlich der zum Zeitpunkt der Bestellung angezeigte Preis.</NP>
            ...
            <NP n={4}>Die angegebenen Lieferzeiten sind Richtwerte. Vowlyra ist nicht verantwortlich für Verzögerungen durch technische Störungen bei Drittanbietern. Beim Express-Paket gilt die Lieferzeit von unter 20 Minuten als vertragliche Leistungspflicht.</NP>
          </Section>

          {/* § 6 */}
          <Section id="sec-6" label="§ 6  Kostenlose Vorschau und Bestellprozess">
            <NP n={1}>Vowlyra bietet vor jeder kostenpflichtigen Bestellung eine kostenlose ca. 30-sekündige Song-Vorschau (Preview) an. Der Trailer wird innerhalb von 3–5 Minuten nach Eingabe der Bestelldaten per E-Mail zugestellt.</NP>
            ...
            <NP n={3}>Gefällt dem Kunden die erhaltene Preview nicht, hat er das Recht auf Anfrage eine kostenlose neue Demo zu erhalten. Dieser Anspruch besteht einmalig pro Bestellung und ist per E-Mail an info@vowlyra.com geltend zu machen.</NP>
          </Section>
          ...
          <Section id="sec-7" label="§ 7  Zahlungssicherheit und PCI-DSS">
            <InfoBox color="#0d1f0d">
              ...
              <p style={{ color: "#888", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
                Die Zahlungsabwicklung auf vowlyra.com erfolgt ausschließlich über PCI-DSS-zertifizierte Zahlungsdienstleister. Vowlyra LLC speichert zu keinem Zeitpunkt vollständige Zahlungsdaten wie Kreditkartennummern oder Bankverbindungen.
              </p>
            </InfoBox>
            ...
            <NP n={2}>Vowlyra LLC hat zu keinem Zeitpunkt Zugriff auf vollständige Kreditkartendaten oder Bankverbindungen des Kunden. Diese werden ausschließlich von Paddle bzw. Stripe in deren sicheren und zertifizierten Systemen verarbeitet.</NP>
            <NP n={3}>Die gesamte Datenkommunikation zwischen dem Browser des Kunden und vowlyra.com erfolgt verschlüsselt über HTTPS/TLS. Der Kunde erkennt am Schlosssymbol in der Browseradresszeile dass die Verbindung gesichert ist.</NP>
            <NP n={4}>Bei Sicherheitsfragen oder Verdacht auf missbräuchliche Nutzung von Zahlungsdaten wende sich der Kunde umgehend an info@vowlyra.com sowie an seinen Zahlungsdienstleister.</NP>
          </Section>

          {/* § 8 */}
          <Section id="sec-8" label="§ 8  Widerrufsrecht und Erlöschen">
            <NP n={1}>Dem Kunden steht grundsätzlich ein gesetzliches Widerrufsrecht von 14 Tagen ab Vertragsschluss zu. Die vollständige Widerrufsbelehrung sowie das Muster-Widerrufsformular sind unter vowlyra.com/widerrufsbelehrung abrufbar und gelten als integraler Bestandteil dieser AGB.</NP>
            <NP n={2}>Das Widerrufsrecht erlischt gemäß § 356 Abs. 5 BGB i.V.m. Art. 16 lit. m Verbraucherrechterichtlinie 2011/83/EU vorzeitig wenn Vowlyra mit der Ausführung des Vertrags begonnen hat, der Kunde vor der Zahlung ausdrücklich zugestimmt hat dass Vowlyra mit der Ausführung vor Ablauf der Widerrufsfrist beginnt und der Kunde bestätigt hat dass er mit dieser Zustimmung sein Widerrufsrecht verliert.</NP>
            ...
            <InfoBox color="#141414">
              ...
              <p style={{ color: "#ccc", fontSize: 13, lineHeight: 1.7, margin: "0 0 8px" }}>
                <strong>Checkbox 1:</strong> Ich stimme ausdrücklich zu dass Vowlyra LLC mit der Ausführung des Vertrags unmittelbar nach meiner Zahlung beginnt. Mir ist bekannt dass ich dadurch mein Widerrufsrecht verliere sobald der Song vollständig bereitgestellt wurde.
              </p>
            ...
            <NP n={4}>Unabhängig vom gesetzlichen Widerrufsrecht gewährt Vowlyra eine freiwillige Erstattungsgarantie gemäß § 9 dieser AGB.</NP>
          </Section>

          {/* § 9 */}
          <Section id="sec-9" label="§ 9  Freiwillige Erstattungsgarantie">
            <NP n={1}>Vowlyra gewährt unabhängig vom gesetzlichen Widerrufsrecht eine freiwillige vollständige Erstattung in folgenden abschließend definierten Fällen:</NP>
            <DataTable headers={["Fall", "Bedingung"]} rows={[
              ...
              ["Fall 4", "Technisches Lieferproblem: Der Kunde kann die MP3-Datei technisch nicht herunterladen und Vowlyra behebt das Problem nicht innerhalb von 48 Stunden."],
            ]} />
            <NP n={2}>Erstattungsanfragen sind per E-Mail an info@vowlyra.com zu richten (Betreff: Erstattungsantrag). Vowlyra bearbeitet Erstattungsanfragen innerhalb von 5 Werktagen. Bei Paddle-Transaktionen beträgt die Erstattungsfrist 30 Tage nach Zahlung. Bei Stripe-Transaktionen ebenfalls 30 Tage.</NP>
            ...
            <NP n={4}>Vowlyra LLC und Paddle bitten den Kunden dringend uns vor Einleitung einer Rückbuchung (Chargeback) direkt zu kontaktieren. Ungerechtfertigte Chargebacks können zur Sperrung des Zugangs zu vowlyra.com führen.</NP>
          </Section>

          {/* § 10 */}
          <Section id="sec-10" label="§ 10  Nutzungsrechte und geistiges Eigentum">
            <NP n={1}>Vowlyra LLC ist Inhaber aller Urheberrechte und sonstigen Schutzrechte an den über vowlyra.com erstellten Songs soweit diese rechtlich schutzfähig sind.</NP>
          ...
          <Section id="sec-11" label="§ 11  Missbräuchliche Nutzung und Exportbeschränkungen">
            ...
            <NP n={2}>Vowlyra behält sich das Recht vor Bestellungen mit missbräuchlichen Inhalten ohne Erstattungspflicht abzulehnen oder zu stornieren sowie bei missbräuchlicher Nutzung den Zugang zur Website zu sperren und rechtliche Schritte einzuleiten.</NP>
            <InfoBox color="#1f1500">
              ...
              <p style={{ color: "#888", fontSize: 13, lineHeight: 1.7, margin: "0 0 6px" }}>
                Das Angebot von Vowlyra richtet sich an Kunden weltweit mit Ausnahme von Personen in Ländern die internationalen Handelssanktionen unterliegen. Die Nutzung von vowlyra.com ist insbesondere verboten für Personen mit Wohnsitz in oder Staatsbürgerschaft von Kuba, Iran, Nordkorea und Syrien sowie den Regionen Krim, Donezk und Luhansk.
              </p>
              <p style={{ color: "#888", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
                Vowlyra LLC behält sich das Recht vor Bestellungen aus sanktionierten Ländern oder Regionen ohne weitere Begründung abzulehnen und bereits geleistete Zahlungen zurückzuerstatten.
              </p>
            </InfoBox>
          </Section>
          ...
          <Section id="sec-12" label="§ 12  Gewährleistung und Haftung">
            <NP n={1}>Vowlyra gewährleistet dass der gelieferte Song den im Bestellprozess eingegebenen Angaben des Kunden entspricht und inhaltlich mit der zuvor zugeschickten Preview übereinstimmt.</NP>
            <NP n={2}>Vowlyra haftet unbeschränkt für Schäden aus der Verletzung des Lebens, des Körpers oder der Gesundheit, Schäden die auf Vorsatz oder grober Fahrlässigkeit beruhen sowie Schäden aus der Verletzung wesentlicher Vertragspflichten (Kardinalpflichten).</NP>
            ...
            <NP n={4}>Im Übrigen ist die Haftung von Vowlyra ausgeschlossen soweit gesetzlich zulässig. Vowlyra haftet nicht für technische Störungen bei Drittanbietern (Cloudflare, Brevo, FAL.ai etc.), Verzögerungen durch höhere Gewalt sowie Schäden durch fehlerhafte Kundenangaben im Bestellprozess.</NP>
            <NP n={5}>Die Haftungsbeschränkungen gelten nicht soweit Vowlyra einen Schaden arglistig verschwiegen oder eine Garantie übernommen hat.</NP>
          </Section>
          ...
          <Section id="sec-13" label="§ 13  Datenschutz">
            <p style={{ color: "#666", fontSize: 14, lineHeight: 1.8, margin: "0 0 12px" }}>
              ...
              <a href="/datenschutz" style={{ color: "#1DB954", textDecoration: "none" }}>vowlyra.com/datenschutz</a>,
          ...
          <Section id="sec-14" label="§ 14  Änderungen der AGB">
            <NP n={1}>Vowlyra behält sich das Recht vor diese AGB jederzeit mit Wirkung für die Zukunft zu ändern. Über wesentliche Änderungen werden registrierte Kunden per E-Mail informiert.</NP>
          ...
          <Section id="sec-15" label="§ 15  Anwendbares Recht und Gerichtsstand">
            ...
            <NP n={3}>Für Klagen gegen Vowlyra LLC durch Verbraucher ist der Gerichtsstand am Wohnsitz des Verbrauchers maßgeblich soweit gesetzlich vorgeschrieben.</NP>
          </Section>
          ...
          <Section id="sec-16" label="§ 16  Streitbeilegung">
            ...
            <NP n={2}>Vowlyra LLC ist nicht bereit und nicht verpflichtet an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</NP>
          </Section>
          ...
          <p style={{ color: "#333", fontSize: 12, borderTop: "1px solid #1e1e1e", paddingTop: 24, marginTop: 16 }}>
            Vowlyra LLC · 30 N Gould St Ste 100, Sheridan, WY 82801, USA · info@vowlyra.com · Version 2.0 · 15.05.2026
          </p>
