...
export default function SongPage() {
  ...
  if (!previewUrl) {
    return (
      <>
        <Nav dark leftLogo="/logo-secondary.png" ctaLabel="Song freischalten" ctaHref={payUrl} />
  ...
  return (
    <>
      <Nav dark leftLogo="/logo-secondary-icon.png" ctaLabel="Song freischalten" ctaHref={payUrl} />
