...
export default function SongPage() {
  ...
  useEffect(() => {
    ...
    if (order_id) {
      ...
      // Fallback-URLs (falls Prefetch fehlschlägt)
      setPayUrlStandard(baseStandard);
      setPayUrlExpress(baseExpress);

      // Stripe Sessions vorab im Hintergrund erstellen
      Promise.all([
        fetch(`${baseStandard}&prefetch=1`).then(r => r.json()),
        fetch(`${baseExpress}&prefetch=1`).then(r => r.json()),
      ]).then(([std, exp]) => {
        if (std.url) setPayUrlStandard(std.url);
        if (exp.url) setPayUrlExpress(exp.url);
        setStripeReady(true);
      }).catch(() => {
  ...
  if (!previewUrl) {
    return (
      <>
        <Nav dark leftLogo="/logo-secondary.png" ctaLabel="Song freischalten" ctaHref={payUrlExpress} />
  ...
  return (
    <>
      <Nav dark leftLogo="/logo-secondary-icon.png" ctaLabel="Song freischalten" ctaHref={payUrlExpress} />
          ...
          <div style={{ maxWidth: 580, margin: "0 auto", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, width: "100%" }}>
              ...
              >
                ...
                <span>Express freischalten – unter 20 Min.</span>
              </a>
              ...
              <a
                ...
                style={{
                  ...
                  textDecoration: "none", transition: "transform 0.15s, border-color 0.15s", letterSpacing: "-0.2px", width: "100%",
                }}
              ...
              >
                ...
                <span>Standard freischalten – 6 Stunden</span>
              </a>
            </div>
          ...
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10, marginTop: 48 }}>
              ...
              >
                ...
                <span>Express – unter 20 Min.</span>
              </a>
              <a
                href={payUrlStandard}
                onClick={(e) => { e.preventDefault(); handleCheckout("standard", payUrlStandard); }}
                style={{
                  ...
                  border: "1.5px solid #333", borderRadius: 500, padding: "14px 36px", fontSize: 14, fontWeight: 700,
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <a
              ...
              style={{
                ...
                background: "linear-gradient(135deg, #1DB954, #17a349)", color: "#000",
                padding: "13px 12px", fontSize: 13, fontWeight: 800, textDecoration: "none",
                borderRadius: 500, letterSpacing: "-0.2px",
              }}
            >
              <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
              <span>Express – 20 Min.</span>
            </a>
            <a
              href={payUrlStandard}
              onClick={(e) => { e.preventDefault(); handleCheckout("standard", payUrlStandard); }}
              style={{
                ...
                padding: "13px 12px", fontSize: 13, fontWeight: 700, textDecoration: "none",
                borderRadius: 500, letterSpacing: "-0.2px",
              }}
            >
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
              <span>Standard – 6 Std.</span>
            </a>
          </div>
